...
! function (a, b, c) {
    ...
    function (a, b) {
        ...
        c.prototype = new d({
            ...
            editTemplate: function (a) {
                ...
                if (a.length>60)
                    b = this.editControl = this._createTextArea();
                else
                    b = this.editControl = this._createTextBox();
                return b.val(a), b
            },
            filterValue: function () {
            ...
            _createTextBox: function () {
                return b("<input>").addClass("form-control text-size-large").attr("type", "text").prop("readonly", !!this.readOnly)
            },
            _createTextArea: function () {
                return b("<textarea>").addClass("form-control text-size-large").prop("readonly", !!this.readOnly)
            }
    ...
    function (a, b) {
        ...
        c.prototype = new d({
            ...
            TextboxClass: "form-control text-size-large",
